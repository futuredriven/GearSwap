...
function init_gear_sets()
    ...
    -- ring1: MISSING Asklepian Ring (from old set)
    ...
    sets.precast.FC = {ammo="Sapience Orb",
        head="Carmine Mask +1",neck="Voltsurge Torque",ear1="Regal Earring",ear2="Loquac. Earring",
    ...
    sets.precast.WS.DT = {ammo="Crepuscular Pebble",
        head="Nyame Helm",neck="Loricate Torque +1",ear1="Dedition Earring",ear2="Brutal Earring",
    ...
    sets.precast.WS['Requiescat'] = set_combine(sets.precast.WS, {ear1="Regal Earring",ring1="Metamor. Ring +1",ring2="Rufescent Ring"})
    sets.precast.WS['Requiescat'].Acc = set_combine(sets.precast.WS.Acc, {ear1="Regal Earring",ring1="Metamor. Ring +1",ring2="Rufescent Ring"})
    ...
    sets.precast.WS['Realmrazer'] = set_combine(sets.precast.WS, {ear1="Regal Earring",ring1="Metamor. Ring +1",ring2="Rufescent Ring"})
    sets.precast.WS['Realmrazer'].Acc = set_combine(sets.precast.WS.Acc, {ear1="Regal Earring",ring1="Metamor. Ring +1",ring2="Rufescent Ring"})
    ...
    sets.precast.WS['Chant du Cygne'] = set_combine(sets.precast.WS, {head="Adhemar Bonnet +1",neck="Mirage Stole +2",ear1="Moonshade Earring",ear2="Telos Earring",body="Gleti's Cuirass",hands="Gleti's Gauntlets",ring2="Begrudging Ring",legs="Gleti's Breeches",feet="Gleti's Boots"})
    sets.precast.WS['Chant du Cygne'].Acc = set_combine(sets.precast.WS.Acc, {head="Adhemar Bonnet +1",neck="Mirage Stole +2",ear1="Moonshade Earring",ear2="Telos Earring",body="Gleti's Cuirass",hands="Gleti's Gauntlets",ring2="Begrudging Ring",legs="Gleti's Breeches",feet="Gleti's Boots"})
    ...
    sets.precast.WS['Savage Blade'] = set_combine(sets.precast.WS, {neck="Mirage Stole +2",ring1="Karieyh Ring",ring2="Rufescent Ring",waist="Sailfi Belt +1"})
    sets.precast.WS['Savage Blade'].Acc = set_combine(sets.precast.WS.Acc, {neck="Mirage Stole +2",ring1="Karieyh Ring",ring2="Rufescent Ring",waist="Sailfi Belt +1"})
    ...
    sets.precast.WS['Expiacion'] = set_combine(sets.precast.WS, {neck="Mirage Stole +2",ring1="Ifrit Ring +1",ring2="Rufescent Ring",waist="Sailfi Belt +1"})
    sets.precast.WS['Expiacion'].Acc = set_combine(sets.precast.WS.Acc, {neck="Mirage Stole +2",ring1="Ifrit Ring +1",ring2="Rufescent Ring",waist="Sailfi Belt +1"})
    ...
    sets.MaxTP = {ear1="Dedition Earring",ear2="Brutal Earring"}
...
--        head="Carmine Mask +1",ear2="Loquac. Earring",
...
--        ,waist="Witful Belt",feet="Carmine Greaves +1"}
    ...
    sets.midcast['Blue Magic'].Physical.Resistant = {ammo="Crepuscular Pebble",
        head="Jhakri Coronal +2",neck="Mirage Stole +2",ear1="Regal Earring",ear2="Telos Earring",
        body="Jhakri Robe +2",hands="Malignance Gloves",ring1="Ifrit Ring +1",ring2="Ilabrat Ring",
        back=gear.wsd_jse_back,waist="Prosilio Belt +1",legs="Jhakri Slops +2",feet="Jhakri Pigaches +2"}
    ...
    sets.midcast['Blue Magic'].Magical.SIRD = {main="Bunzi's Rod",sub="Sakpata's Sword",ammo="Staunch Tathlum +1",
         ...
         body="Amalric Doublet +1",ring1="Metamor. Ring +1",ring2="Defending Ring",
    ...
    sets.midcast['Blue Magic'].Magical.Proc = {ammo="Hasty Pinion +1",
        head="Carmine Mask +1",ear1="Regal Earring",ear2="Loquac. Earring",
        body=gear.relic_body,hands="Leyline Gloves",ring1="Kishar Ring",ring2="Prolix Ring",
    ...
    sets.midcast['Blue Magic'].Magical.Resistant = set_combine(sets.midcast['Blue Magic'].Magical,
        {neck="Mirage Stole +2",ring1="Stikini Ring +1",ring2="Stikini Ring +1"})
    ...
    sets.midcast['Blue Magic'].MagicAccuracy = {main="Tizona",sub="Sakpata's Sword",ammo="Pemphredo Tathlum",
        head=gear.artifact_head,neck="Mirage Stole +2",ear1="Regal Earring",ear2="Digni. Earring",
    ...
    -- MISSING: ring2 Weatherspoon Ring
    sets.element.Light = {} --

    -- MISSING: hands Telchine Gloves
    sets.midcast.Cure = {main="Bunzi's Rod",sub="Sakpata's Sword",ammo="Staunch Tathlum +1",
        head="Nyame Helm",neck="Loricate Torque +1",ear1="Regal Earring",ear2="Genmei Earring",
        body="Vrikodara Jupon",ring1="Metamor. Ring +1",ring2="Menelaus's Ring",
    ...
    sets.midcast.UnlockedCure = {main="Bunzi's Rod",sub="Sakpata's Sword",ammo="Staunch Tathlum +1",
        head="Nyame Helm",neck="Loricate Torque +1",ear1="Regal Earring",ear2="Genmei Earring",
        body="Nyame Mail",ring1="Metamor. Ring +1",ring2="Menelaus's Ring",
        back="Oretan. Cape +1",waist="Luminary Sash",legs="Nyame Flanchard",feet="Nyame Sollerets"}
    ...
    sets.midcast['Blue Magic'].Breath = {ammo="Mavi Tathlum",neck="Mirage Stole +2",ear1="Regal Earring",ear2="Digni. Earring",
        body=gear.artifact_body,ring1="Kunaji Ring",
    ...
    sets.midcast['Blue Magic'].UnlockedAoEHealing = {main="Bunzi's Rod",sub="Sakpata's Sword",ammo="Staunch Tathlum +1",
        head="Nyame Helm",neck="Unmoving Collar +1",ear2="Odnowa Earring +1",
        body="Nyame Mail",
    ...
    sets.midcast['Blue Magic'].Healing = {main="Bunzi's Rod",sub="Sakpata's Sword",ammo="Staunch Tathlum +1",
        head="Nyame Helm",neck="Loricate Torque +1",ear2="Odnowa Earring +1",
        body="Vrikodara Jupon",
    ...
    sets.midcast['Blue Magic'].UnlockedHealing = {main="Bunzi's Rod",sub="Sakpata's Sword",ammo="Staunch Tathlum +1",
        head="Nyame Helm",neck="Loricate Torque +1",ear1="Regal Earring",ear2="Genmei Earring",
        body="Nyame Mail",ring1="Metamor. Ring +1",waist="Luminary Sash",legs="Nyame Flanchard",feet="Nyame Sollerets"}
    ...
    -- MISSING: hands Rawhide Gloves
    sets.midcast['Blue Magic'].SkillBasedBuff = {main="Iris",ammo="Mavi Tathlum",neck="Mirage Stole +2",ear2="Digni. Earring",
        body=gear.artifact_body,ring1="Stikini Ring +1",ring2="Stikini Ring +1",
    ...
    -- MISSING: ear1 Gifted Earring
    -- MISSING: hands Rawhide Gloves
    sets.midcast['Blue Magic'].Buff = {main="Vampirism",sub="Vampirism",ammo="Mavi Tathlum",neck="Mirage Stole +2",ear2="Digni. Earring",
        body=gear.artifact_body,ring1="Stikini Ring +1",ring2="Stikini Ring +1",
        back="Perimede Cape",waist="Witful Belt",legs=gear.empyrean_legs,feet=gear.relic_feet}
    ...
    sets.idle.PDT = {main="Sakpata's Sword",sub="Genmei Shield",ammo="Staunch Tathlum +1",
        head="Gleti's Mask",neck="Loricate Torque +1",ear1="Etiolation Earring", ear2="Ethereal Earring",
        body="Gleti's Cuirass",hands="Gleti's Gauntlets",ring1="Defending Ring",ring2="Purity Ring",
        back=gear.stp_jse_back,waist="Flume Belt +1",legs="Gleti's Breeches",feet="Gleti's Boots"}
    ...
    sets.defense.MDT = {main="Bolelabunga",sub="Genmei Shield",ammo="Staunch Tathlum +1",
        head="Gleti's Mask",ear1="Etiolation Earring",ear2="Sanare Earring",
        body="Gleti's Cuirass",hands="Gleti's Gauntlets",ring1="Defending Ring",ring2="Purity Ring",
    ...
    sets.defense.MEVA = {main="Bolelabunga",sub="Genmei Shield",ammo="Staunch Tathlum +1",
        head="Jhakri Coronal +2",ear1="Etiolation Earring",ear2="Sanare Earring",
    ...
    sets.Knockback = {}
    sets.MP = {waist="Flume Belt +1",ear1="Etiolation Earring", ear2="Ethereal Earring"}
    sets.MP_Knockback = {}
    sets.SuppaBrutal = {ear1="Dedition Earring", ear2="Brutal Earring"}
    sets.DWEarrings = {ear1="Dedition Earring",ear2="Eabani Earring"}
    sets.DWMax = {ear1="Dedition Earring",ear2="Eabani Earring",body="Adhemar Jacket +1",waist="Reiki Yotai",legs="Carmine Cuisses +1"}
    ...
    sets.engaged.AM = {ammo="Coiste Bodhar",
                head="Adhemar Bonnet +1",neck="Mirage Stole +2",ear1="Dedition Earring",ear2="Telos Earring",
    ...
    sets.engaged.Fodder = {main="Tizona",sub="Thibron",ammo="Coiste Bodhar",
                head="Adhemar Bonnet +1",neck="Mirage Stole +2",ear1="Dedition Earring",ear2="Brutal Earring",
    ...
    sets.MagicBurst = {body="Amalric Doublet +1",hands="Amalric Gages +1",legs=gear.artifact_legs,ring1="Mujin Band",ring2="Purity Ring"}
