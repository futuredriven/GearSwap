...
function user_job_setup()
	...
	-- Reforged Gear
	gear.artifact_head = {name="Acad. Mortarboard +1"}
	gear.artifact_body = {name="Acad. Gown +1"}	
	gear.artifact_hands = {name="Acad. Bracers +1"}
	gear.artifact_legs = {name="Acad. Pants +1"}
	gear.artifact_feet = {name="Acad. Gaiters +1"}

	gear.relic_head = {name="Pedagogy Mortarboard"}
	gear.relic_body = {name="Pedagogy Gown"}	
	gear.relic_hands = {name="Pedagogy Bracers"}
	gear.relic_legs = {name="Pedagogy Pants"}
	gear.relic_feet = {name="Pedagogy Loafers"}

	gear.empyrean_head = {name="Arbatel Bonnet"}
	gear.empyrean_body = {name="Arbatel Gown"}	
	gear.empyrean_hands = {name="Arbatel Bracers"}
	gear.empyrean_legs = {name="Arbatel Pants"}
	gear.empyrean_feet = {name="Arbatel Loafers"}
...
function init_gear_sets()
    ...
    sets.midcast.Cure = {main="Gada",sub="Sors Shield",ammo="Hasty Pinion +1",
        head="Kaykaus Mitra",neck="Incanter's Torque",ear1="Meili Earring",ear2="Malignance Earring",
	...
	sets.midcast['Enhancing Magic'] = {main="Gada",sub="Ammurapi Shield","Savant's Treatise",
    ...
    sets.resting = {main="Chatoyant Staff",sub="Oneiros Grip",ammo="Homiliary",
		...
		back=gear.idle_jse_back,waist="Fucho-no-obi",legs="Assid. Pants +1",feet=gear.chironic_refresh_feet}
    ...
    sets.idle = {main="Bolelabunga",sub="Genmei Shield",ammo="Homiliary",
        ...
        back=gear.idle_jse_back,waist="Carrier's Sash",legs="Assid. Pants +1",feet="Nyame Sollerets"}
    ...
    sets.idle.PDT = {main="Malignance Pole",sub="Umbra Strap",ammo="Staunch Tathlum +1",
        ...
        back=gear.idle_jse_back,waist="Carrier's Sash",legs="Nyame Flanchard",feet="Agwu's Pigaches"}
    ...
    sets.idle.Weak = {main="Bolelabunga",sub="Genmei Shield",ammo="Homiliary",
        ...
        back=gear.idle_jse_back,waist="Carrier's Sash",legs="Assid. Pants +1",feet=gear.chironic_refresh_feet}
    ...
    sets.defense.PDT = {main="Malignance Pole",sub="Umbra Strap",ammo="Staunch Tathlum +1",
        ...
        back=gear.idle_jse_back,waist="Carrier's Sash",legs="Nyame Flanchard",feet="Battlecast Gaiters"}
	...
	sets.engaged.PDT = {main="Malignance Pole", sub="Oneiros Grip",ammo="Staunch Tathlum +1",
        head="Gende. Caubeen +1",neck="Loricate Torque +1",ear1="Etiolation Earring",ear2="Ethereal Earring",
        body="Vrikodara Jupon",hands="Gende. Gages +1",ring1="Defending Ring",ring2="Dark Ring",
        back=gear.idle_jse_back,waist="Carrier's Sash",legs="Nyame Flanchard",feet=gear.chironic_refresh_feet}
