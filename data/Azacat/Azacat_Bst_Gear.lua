function user_job_setup()
	...
	state.Weapons:options('None','PetPDTAxe','DualWeapons','AgwuSacro')
	state.ExtraMeleeMode = M{['description']='Extra Melee Mode','None','Knockback','Suppa','DWEarrings'}
	-- state.AutoReadyType:options('Default','AOE', 'Physical', 'Magical')
	...
	gear.artifact_hands = {name="Totemic Gloves +1"}
	gear.artifact_legs = {name="Totemic Trousers +1"}
	gear.artifact_feet = {name="Totemic Gaiters +1"}

	gear.relic_head = {name="Ankusa Helm +1"}
	gear.relic_body = {name="Ankusa Jackcoat +1"}	
	gear.relic_hands = {name="Ankusa Gloves +1"}
	gear.relic_legs = {name="Ankusa Trousers +1"}
	gear.relic_feet = {name="Ankusa Gaiters +1"}

	gear.empyrean_head = {name="Nukumi Cabasset +1"}
	gear.empyrean_body = {name="Nukumi Gausape +1"}	
	gear.empyrean_hands = {name="Nukumi Manoplas +1"}
	gear.empyrean_legs = {name="Nukumi Quijotes +1"}
	gear.empyrean_feet = {name="Nukumi Ocreae +1"}
...
function init_gear_sets()
	...
	sets.precast.JA['Feral Howl'] = {range="Ullr",ammo=empty,
		head="Nyame Helm",neck="Bst. Collar +2",ear1="Digni. Earring",ear2="Crep. Earring ",
	...
	sets.precast.JA.Reward = {
		head="Stout Bonnet",neck="Aife's Medal",ear1="Etiolation Earring",ear2="Lifestorm Earring", --Pratik Earring
		body=gear.relic_body,hands="Malignance Gloves",ring1="Stikini Ring +1",ring2="Stikini Ring +1",
		back=gear.chr_jse_back,waist="Engraved Belt",legs=gear.relic_legs,feet=gear.relic_feet}
	...
	sets.precast.JA.Charm = {
		head=gear.artifact_head,neck="Bst. Collar +2",ear1="Digni. Earring",ear2="Crep. Earring ",
	...
	sets.precast.WS = {ammo="Voluspa Tathlum",
		...
		back="Bleating Mantle",waist="Fotia Belt",legs="Gleti's Breeches",feet="Gleti's boots"}
	...
	sets.weapons.AgwuSacro = {main ="Agwu's Axe",sub="Sacro Bulwark"}	
