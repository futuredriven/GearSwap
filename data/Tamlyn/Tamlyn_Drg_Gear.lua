...
function init_gear_sets()
	...
	sets.precast.JA.Jump = {ammo="Ginsen",
		...
		body="Ptero. Mail +2",hands="Vis. Fng. Gaunt. +2",ring1="Petrov Ring",ring2="Niqmaddu Ring",
		back=gear.stp_jse_back,waist="Ioskeha Belt +1",legs="Ptero. Brais +2",feet="Ostro Greaves"}
	sets.precast.JA['Ancient Circle'] = {}
	sets.precast.JA['High Jump'] = {ammo="Ginsen",
		head="Flam. Zucchetto +2",neck="Lissome Necklace",ear1="Telos Earring",ear2="Sherida Earring",
		body="Ptero. Mail +2",hands="Vis. Fng. Gaunt. +2",ring1="Petrov Ring",ring2="Niqmaddu Ring",
		back=gear.stp_jse_back,waist="Ioskeha Belt +1",legs="Vishap Brais +3",feet="Ostro Greaves"}
	...
	sets.precast.JA['Spirit Jump'] = {ammo="Ginsen",
		head="Flam. Zucchetto +2",neck="Lissome Necklace",ear1="Telos Earring",ear2="Sherida Earring",
		body="Vishap Mail +2",hands="Vis. Fng. Gaunt. +2",ring1="Petrov Ring",ring2="Niqmaddu Ring",
		back=gear.stp_jse_back,waist="Ioskeha Belt +1",legs="Ptero. Brais +2",feet="Ostro Greaves"}
	...
	sets.precast.WS['Geirskogul'] = set_combine(sets.precast.WS, {back=gear.dex_ws_jse_back})
