function user_job_setup()
	...
	state.Weapons:options('None','Excalibur','Sequence','Naegling','SalvageBlade','DualClubs','EnspellDW','Maxentius')
...
function init_gear_sets()
	...
	-- Fast cast sets for spells (RDM 38% + 42% Gear = 80%)
	
	sets.precast.FC = {range=empty,ammo="Impatiens",
		head="Atrophy Chapeau +3",ear1="Loquac. Earring",ear2="Malignance Earring",
		body="Viti. Tabard +2",hands="Leyline Gloves",
	...
	sets.precast.WS.Proc = 	{range=empty,ammo="Hasty Pinion +1",
		head="Viti. Chapeau +2",neck="Combatant's Torque",ear1="Moonshade Earring",ear2="Regal Earring",
		body="Vitiation tabard +2",hands="Atrophy Gloves +3",ring1="Rufescent Ring",ring2="Karieyh Ring",
	...
	sets.precast.WS['Requiescat'] = {range=empty,ammo="Regal Gem",
		head="Viti. Chapeau +2",neck="Fotia Gorget",ear1="Moonshade Earring",ear2="Regal Earring",
	...
	sets.precast.WS['Savage Blade'] = {range=empty,ammo="Crepuscular Pebble",
		...
		body="Nyame Mail",hands="Malignance Gloves",ring1="Rufescent Ring",ring2="Karieyh Ring",
		back=gear.wsd_jse_back,waist="Sailfi Belt +1",legs="Nyame Flanchard",feet="Leth. Houseaux +2"}
...
--		head="Atrophy Chapeau +3",ear1="Loquac. Earring",ear2="Malignance Earring",
--		body="Viti. Tabard +2",hands="Leyline Gloves",
--		waist="Witful Belt",legs="Psycloth Lappas",feet=gear.carmine_feet_path_d} -- back="Perimede Cape"
    ...
    sets.midcast.LightDayCure = {main="Chatoyant Staff",sub="Curatio Grip",range=empty,ammo="Hasty Pinion +1", -- Daybreak
        head="Kaykaus Mitra +1",neck="Incanter's Torque",ear1="Beatific earring",ear2="Roundel Earring", -- Meili Earring / Mendicant's earring
        body="Kaykaus Bliaut +1",hands="Kaykaus Cuffs +1",ring1="Menelaus's Ring",ring2="Stikini Ring +1 ",
        back="Twilight Cape",waist="Hachirin-no-Obi",legs="Kaykaus Tights +1",feet="Kaykaus Boots +1"}
	...
	sets.midcast.Cursna = {main="Prelatic pole",sub="Curatio Grip",range=empty,ammo="Staunch Tathlum +1",
        ...
        body="Viti. Tabard +2",hands="Kaykaus Cuffs +1",ring1="Menelaus's Ring",ring2="Haoma's Ring",
        back="Oretan. Cape +1",waist="Gishdubar Sash",legs="Atrophy Tights +3",feet="Vanya Clogs"}
	...
	sets.midcast['Enhancing Magic'] = {main="Colada",sub="Ammurapi Shield",range=empty,ammo="Staunch Tathlum +1",
		...
		body="Viti. Tabard +2",hands="Viti. Gloves +2",ring1="Stikini Ring +1",ring2="Stikini Ring +1",
		back="Ghostfyre cape",waist="Olympus Sash",legs="Atrophy Tights +3",feet="Leth. Houseaux +2"}

	--Atrophy Gloves are better than Lethargy for me despite the set bonus for duration on others.		
	sets.buff.ComposureOther = {head="Leth. Chappel +1",
		body="Lethargy Sayon +1",hands="Leth. Gantherots +2",
		legs="Leth. Fuseau +2",feet="Leth. Houseaux +2"}
		
	--Red Mage enhancing sets are handled in a different way from most, layered on due to the way Composure works
	--Don't set combine a full set with these spells, they should layer on Enhancing Set > Composure (If Applicable) > Spell
	sets.EnhancingSkill = {main="Pukulatmuj +1",head=gear.carmine_head_path_d,neck="Incanter's Torque",hands="Viti. Gloves +2",back="Ghostfyre Cape",waist="Olympus Sash",legs="Atrophy Tights +3"}
	...
	sets.midcast['Enfeebling Magic'] = {main="Maxentius",sub="Ammurapi Shield",range=empty,ammo="Regal Gem",
		head="Viti. Chapeau +2",neck="Dls. Torque +2",ear1="Snotra Earring",ear2="Malignance Earring",
		body="Lethargy Sayon +1",hands="Kaykaus Cuffs +1",ring1="Kishar Ring",ring2="Stikini Ring +1",
		back=gear.mnd_jse_back,waist="Obstin. Sash",legs="Chironic Hose",feet="Vitiation Boots +2"}
	...
	sets.midcast['Enfeebling Magic'].Resistant = {main="Maxentius",sub="Ammurapi Shield",range="Ullr",ammo=empty,
		...
		back=gear.mnd_jse_back,waist="Luminary Sash",legs="Chironic Hose",feet="Vitiation Boots +2"}
		
	sets.midcast.DurationOnlyEnfeebling = set_combine(sets.midcast['Enfeebling Magic'], {body="Atrophy Tabard +3",range="Ullr"})
	...
	sets.midcast.SkillBasedEnfeebling = set_combine(sets.midcast['Enfeebling Magic'], {ear1="Vor Earring",hands="Leth. Gantherots +2",ring1="Stikini Ring +1"})
    ...
    sets.midcast['Elemental Magic'].Proc = {main=empty,sub=empty,range=empty,ammo="Impatiens",
        head="Leth. Chappel +1",neck="Dls. Torque +2",ear1="Malignance Earring",ear2="Loquac. Earring",
        body="Lethargy Sayon +1",hands="Leth. Gantherots +2",ring1="Kishar Ring",ring2="Prolix Ring",
        back=gear.enmity_jse_back,waist="Flume Belt +1",legs="Leth. Fuseau +2",feet="Leth. Houseaux +2"}
	...
	sets.midcast.Impact = {main="Maxentius",sub="Ammurapi Shield",range="Ullr",ammo=empty,
		...
		back=gear.int_jse_back,waist="Acuity Belt +1 ",legs="Chironic Hose",feet="Vitiation Boots +2"}
    ...
    sets.midcast.Drain = {main="Rubicundity",sub="Ammurapi Shield",range="Ullr",ammo=empty,
        ...
        body="Atrophy Tabard +3",hands="Leth. Gantherots +2",ring1="Evanescence Ring",ring2="Archon Ring",
	...
	sets.midcast.Stun = {main="Maxentius",sub="Ammurapi Shield",range="Ullr",ammo=empty,
		head="Atrophy Chapeau +3",neck="Dls. Torque +2",ear1="Snotra Earring",ear2="Malignance Earring", -- Regal Earring Snotra Earring Malignance Earring
		body="Zendik Robe",hands="Leth. Gantherots +2",ring1="Metamor. Ring +1",ring2="Stikini Ring +1",
	...
	sets.idle.Weak = {main="Sakpata's Sword",sub="Sacro Bulwark",range=empty,ammo="Staunch Tathlum +1",
		head="Nyame Helm",neck="Loricate Torque +1",ear1="Etiolation Earring",ear2="Ethereal Earring",
		body="Nyame Mail",hands="Nyame Gauntlets",ring1="Defending Ring",ring2="Patricus Ring",
		back=gear.enmity_jse_back,waist="Flume Belt +1",legs="Nyame Flanchard",feet="Nyame Sollerets"}
	
	sets.idle.DTHippo = set_combine(sets.idle.PDT, {back=gear.enmity_jse_back,legs=gear.carmine_legs_path_d,feet="Hippo. Socks +1"})
	...
	-- Weapons sets
	sets.weapons.Excalibur = {main="Excalibur",sub="Sacro Bulwark",range=empty}
	sets.weapons.Sequence = {main="Sequence",sub="Sacro Bulwark",range=empty}
	sets.weapons.Naegling = {main="Naegling",sub="Sacro Bulwark",range=empty}
	sets.weapons.SalvageBlade = {main="Naegling",sub="Thibron",range=empty}
	sets.weapons.EnspellDW = {main="Pukulatmuj +1",sub="Pukulatmuj",range="Ullr",ammo=empty}
	...
	sets.weapons.Odin = {main="Extinction",sub="Sacro Bulwark",range="Ullr",ammo=empty}
	...
	sets.engaged.DW.FullAcc = {ammo="Aurgelmir Orb +1",
		head="Malignance Chapeau",neck="Combatant's Torque",ear1="Eabani Earring",ear2="Telos Earring",
		...
		if state.AutoTrustMode.value and not data.areas.cities:contains(world.area) and (buffactive['Elvorseal'] or buffactive['Reive Mark'] or not player.in_combat) then
			...
			if party.p5 == nil then
				...
				if spell_recasts[980] < spell_latency and not have_trust("Yoran-Oran") then
					windower.chat.input('/ma "Karaha-Baruha" <me>')
...
autows_list = {['Naegling']='Savage Blade',['DualWeapons']='Savage Blade',['DualWeaponsAcc']='Savage Blade',['DualEvisceration']='Evisceration',['DualClubs']='Black Halo',['DualAeolian']='Aeolian Edge',['EnspellDW']='Seraph Blade'}
